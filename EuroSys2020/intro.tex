...
Typically, the primary attribute %-- called the \emph{primary key} -- 
...
because their cache granularity is too high, which results in poor-performing near-random writes~\cite{toku-rocks-inno}.  
