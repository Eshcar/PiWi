...
\caption{\inred{Distribution of mobile app events by app id (log-log scale) in a production analytics feed (200M events).}}
\label{fig:cdf}
\end{figure}
...
Storage systems use system-level WALs for the write-path.
