...
This approach is used in many domains, for example, 
(1) In messaging and email applications, keys are typically a concatenation of user id with additional fields 
...
(3) Mobile analytics services such as Flurry Analtyics~\cite{flurry} aggregate statistics 
...
In this work, we make spatial locality a first class consideration in KV-stores design.
...
For such cases, the LSM approach may well be more suitable than our range-based design.  
