...
VT-Trees~\cite{vttrees} are LSM-trees apply a stitching policy that avoids re-writing already sorted data, thereby improving performance and significantly reducing write amplification in sequential workloads like time-based ingestion, and file-system workloads. 
