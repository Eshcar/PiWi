...
We allocate a quota of 12 GB RAM (out of the 16 GB container) to the munk and row caches, 
and split it between the two at a $2:1$ ratio. The row cache uses 3 hash tables.  
