...
is also faster wrt the 95\% put and get latency metrics in this scenario.}} With simple keys,
 it is faster than RocksDB only for small datasets that fit in memory, and slower for big datasets.  
