...
This section provides details about some of our implementation choices. 

%PO array is split into PSA and per-chunk PPAs, as kiwi; DO NOT MENTION employs  helping as in KiWi. 
\paragraph{Chunk index.}  Implemented as a sorted array holding the minimal keys of all chunks.  
...
\paragraph{Row cache.} 
We implement a coarse-grained LRU policy by maintaining a fixed-size queue of hash tables. 
