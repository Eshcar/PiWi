...
% In many applications, data locality is in ranges
...
Similarly, social network applications \Idit{Check linkbench}
and analytics (Flurry).


\Idit{LSM is not ideal for this  because of (1) write path and (2) read path.

We propose a better design for data with locality in ranges.
}
