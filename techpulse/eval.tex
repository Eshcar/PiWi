...
We experimented with workloads that are derived from Flurry application production data to compare performance of \sys\ and RocksDB. 
...
We then used this data to generate composite keys with the application name as the main field and the timestamp as secondary field. 
...
Unless otherwise stated, the YCSB driver  
...
\caption{E -- 5\% put, 95\% scan (1000 rows)}
