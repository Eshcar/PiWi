...
\inred{For example, Figure~\ref{fig:cdf} depicts the comulative distribution function of application name in 15 minutes of Flurry data pertaining around 200M events of over 40K applications.
It shows that 10\% of the application cover over 99.5\% of the events; 1\% of the applications cover 94\% of the events; and less than 0.1\% cover 70\% of the events. This means the data is highly skewed and with a very long tail (that is not depicted in the figure).
Table~\ref {table:popular} shows the comulative distribution of the top-20 popular application, covering more than 50\% of the events. }
