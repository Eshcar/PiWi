...
\inred{
Our experiments, based on Flurry data show ingestion throughput is 3x higher for \sys, while write amplification is 2.5-4.5x higher for RocksDB. \sys improves scans speed by Xx in medium size data bases and by Yx in large databases.}
